...
import (
	_ "dubbo-go-jsonRpc-demo/demo2/filter"
...
func main() {
	...
	if err = srvJsonRpc.Register(&GreetProvider{}, nil, server.WithInterface("GreetProvider"), server.WithFilter("myCustomFilter")); err != nil {
		panic(err)
	}
